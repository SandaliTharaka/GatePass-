...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    setUserRoles(role ? role.split(',').map(r => r.trim()) : []);
  }, []);
              ...
              <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex space-x-2">
                          ...
                          <button
                            ...
                            className={`px-4 py-2 rounded-lg text-white font-medium flex items-center ${isUploading || !location ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'
                              }`}
                          >
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <button
                            ...
                            className={`px-4 py-2 rounded-lg text-white font-medium ${isUploading || !locationFile ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'
                              }`}
                          >
                            Upload
                          </button>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex space-x-2">
                          ...
                          <button
                            ...
                            className={`px-4 py-2 rounded-lg text-white font-medium flex items-center ${isUploading || !category ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'
                              }`}
                          >
                            <FaPlus className="mr-2" /> Add
                          </button>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <button
                            ...
                            className={`px-4 py-2 rounded-lg text-white font-medium ${isUploading || !categoryFile ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'
                              }`}
                          >
                            Upload
                          </button>
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className={`px-6 py-3 rounded-lg text-white font-medium flex items-center ${isUploading ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'
                      }`}
                  >
                    {isUploading ? (
                      <>
