...
export const approveStatus = async (referenceNumber, comment, branches, loadingDetails) => {
    try {
      const response = await axios.put(`${API_BASE_URL}/approve/${referenceNumber}/approve`, { comment, branches, loadingDetails });
      return response.data;
    } catch (error) {
